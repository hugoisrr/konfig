<div class="form-group row">
    ...
    <div class="col-md-9">
        <input id="title-{{ $languageInput }}" type="text" class="form-control form-control-lg @error('title-'.$languageInput) is-invalid @enderror" name="title-{{ $languageInput }}" value="{{ old('title-'.$languageInput) }}" autofocus>
...
<div class="form-group row">
    ...
    <div class="col-md-9">
        <textarea id="description-{{ $languageInput }}" class="form-control @error('description-'.$languageInput) is-invalid @enderror" name="description-{{ $languageInput }}" rows="5" autofocus>{{ old('description-'.$languageInput) }}</textarea>
